...
import 'package:vk_chat/ui/items/message/current_user_message.dart';
import 'package:vk_chat/ui/items/message/user_message.dart';
...
class MessageItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return currentUser != null && message.fromId == currentUser.id
        ? CurrentUserMessage(message, historyHandler)
        : buildIncomingMessage();
  }

  Widget buildIncomingMessage() {
    if (chat != null) return AvatarUserMessage(message: message, handler: historyHandler);
    return UserMessage(message, historyHandler);
  }
